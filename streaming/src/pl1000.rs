//! Streaming stub for the PicoLog 1000 series data logger.
//!
//! No behavior yet - [`crate::StreamDevice`] will be implemented once the poll/stream model is
//! read from the PicoLog 6 reference (`packages/driver-pl-1000/`, see
...
/// Placeholder stream event for the PL1000. Shape lands with the real streaming implementation.
#[derive(Clone, Debug)]
