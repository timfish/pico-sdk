...
use pico_sys_dynamic::ps6000::PS6000Bindings;
use std::sync::Arc;

pub struct PS6000Driver {
    _dependencies: LoadedDependencies,
    bindings: PS6000Bindings,
}
...
impl OscilloscopeDriverInternal for PS6000Driver {
