...
impl From<PicoRange> for i32 {
    fn from(value: PicoRange) -> Self {
        num::ToPrimitive::to_i32(&value).expect("Non-valid range")
    }
}

impl From<PicoRange> for i16 {
    fn from(value: PicoRange) -> Self {
        num::ToPrimitive::to_i16(&value).expect("Non-valid range")
    }
}

impl From<i32> for PicoRange {
    fn from(value: i32) -> Self {
        num::FromPrimitive::from_i32(value).expect("Non-valid range")
    }
}
...
impl PicoRange {
    ...
    pub fn get_units(self) -> UnitStrings {
        match self {
            ...
            | PicoRange::CURRENT_CLAMP_100A_100A => UnitStrings::new("Amps", "A"),
            _ => UnitStrings::new("Volts", "V"),
        }
    }

    /// Get the maximum scaled value for this range
    pub fn get_max_scaled_value(self) -> f32 {
        match self {
