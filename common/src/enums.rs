...
impl From<PicoChannel> for i32 {
    fn from(value: PicoChannel) -> Self {
        num::ToPrimitive::to_i32(&value).expect("Non-valid channel")
    }
}

impl From<PicoChannel> for i16 {
    fn from(value: PicoChannel) -> Self {
        num::ToPrimitive::to_i16(&value).expect("Non-valid channel")
    }
}

impl From<i32> for PicoChannel {
    fn from(value: i32) -> Self {
        num::FromPrimitive::from_i32(value).expect("Non-valid channel")
    }
}
...
impl From<PicoCoupling> for i32 {
    fn from(value: PicoCoupling) -> Self {
        num::ToPrimitive::to_i32(&value).expect("Non-valid coupling")
    }
}

impl From<PicoCoupling> for i16 {
    fn from(value: PicoCoupling) -> Self {
        num::ToPrimitive::to_i16(&value).expect("Non-valid coupling")
    }
}
...
impl From<DownsampleMode> for i32 {
    fn from(value: DownsampleMode) -> Self {
        num::ToPrimitive::to_i32(&value).expect("Non-valid downsample mode")
    }
}
...
impl From<PicoInfo> for u32 {
    fn from(value: PicoInfo) -> Self {
        num::ToPrimitive::to_u32(&value).expect("Non-valid info type")
    }
}

impl From<PicoInfo> for i16 {
    fn from(value: PicoInfo) -> Self {
        num::ToPrimitive::to_i16(&value).expect("Non-valid info type")
    }
}
